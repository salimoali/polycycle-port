...
<p float="left">
  <img src="assets/sankey_screenshot.jpeg" width="45%" alt="Sankey diagram of energy and material flows across the five-plant cluster" />
  <img src="assets/network_analysis_screenshot.jpeg" width="45%" alt="Energy-layer network analysis of the plant cluster" />
</p>

*Left: Sankey diagram (Chapter 6.1.2). Right: energy-layer network analysis.*
