...
| System integration diagram | Static system-representation diagram, all 5 plants + 7 interventions (Chapter 6.1.2) | Mine |
...
| Material-balance Linny-R model | Park-wide mass-flow network underpinning the Chapter 6.1.2 diagrams | Team |
...
| CHP retrofit economics & feasibility | Utility balance, CO₂ savings, TONF, trade-off matrix, spider diagram, CAPEX/NPV/BCR/payback (Chapter 6) | Team |
...
│   └── integrated-project-material.lnr           # park-wide mass-balance network (team)
├── analysis/
│   ├── sankey_polycycle.py                    # interactive Plotly Sankey source (mine)
│   ├── 6_1_2_sankey_polycycle.html             # rendered Sankey output (mine)
│   ├── system_integration_diagram.py          # static system diagram source, matplotlib (mine)
│   ├── 6_1_2_system_integration_diagram.png    # rendered system diagram output (mine)
│   └── chp_retrofit_analysis/                 # CHP economics notebook + Chapter5.xlsx/Chapter6.xlsx (team)
└── sna/
