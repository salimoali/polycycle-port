...
├── S01-S07 Intervention Table.md              # supplementary table documenting S-01–S-07 (mine)
├── sankey_polycycle.py                        # interactive Plotly Sankey source (mine)
├── 6_1_2_sankey_polycycle.html                # rendered Sankey output (mine)
├── energy_layer_network_analysis.ipynb        # multilayer stakeholder/process network analysis (mine)
└── README.md
